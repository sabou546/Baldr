/*
 * VTextIcon.java
 * from : http://www.macdevcenter.com/pub/a/mac/2002/03/22/vertical_text.html
 * Created on 12 mai 2007, 15:02
 *$Id: VTextIcon.java 200 2007-05-26 23:02:02Z zeta $
 */
package ca.qc.bdeb.baldr.ihm.renderers.utils;
...
public class VTextIcon implements Icon, PropertyChangeListener {
    ...
    /**
     * Checks for changes to the font on the fComponent so that it can
     * invalidate the layout if the size changes
     */
     ...
     * that the characters are ordered from top to bottom. Latin text and
     ...
     * (Mongolian) or right-to-left (other scripts). Most characters use the
     * same shape and orientation when displayed horizontally or vertically, but
     * many punctuation characters will change their shape when displayed
     * vertically.
     *
