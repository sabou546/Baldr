...
public class PreviewTab extends javax.swing.JPanel {
     ...
     */
    public PreviewTab(int tabnum, ResourceBundle messages) {
    ...
    private void initComponents() {
        ...
        UIsum_desc.setText(messages.getString("Report")); // NOI18N

        UIfiles_desc.setText(messages.getString("Files_c")); // NOI18N
        ...
        UIdnum_desc.setText(messages.getString("Directories_c")); // NOI18N
