/*
 * Copyright : http://tips4java.wordpress.com/2008/11/10/table-column-adjuster/
 */
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
    ...
    private HashMap<TableColumn, Integer> columnSizes = new HashMap<TableColumn, Integer>();
